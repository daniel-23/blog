    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <i class="flag-icon flag-icon-us" v-if="$page.props.locale == 'en'"></i>
                        <i class="flag-icon flag-icon-es" v-if="$page.props.locale == 'es'"></i>
                    </a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="image" v-if="$page.props.jetstream.managesProfilePhotos">
                        <img :src="$page.props.user.profile_photo_url" :alt="$page.props.user.name" class="img-circle elevation-2">
                    </div>
                    <div class="info">                        
                        <inertia-link :href="route('profile.show')" class="d-block">{{ $page.props.user.name }}</inertia-link>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                        ...
                        <li v-if="can('Security')" class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <inertia-link :href="route('permissions.index')" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{ __('Permissions') }}</p>
                                    </inertia-link>
                                </li>
