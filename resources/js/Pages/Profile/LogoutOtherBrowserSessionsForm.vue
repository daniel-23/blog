        ...
        <jet-action-section>
            ...
            <template #content>
                ...
                <div class="flex items-center mt-5">
                    <jet-button class="btn-warning" @click="confirmLogout">
                ...
                <jet-dialog-modal :show="confirmingLogout" @close="closeModal" :idModal="idModal">
                    <template #title>
                        {{ __('Log Out Other Browser Sessions') }}
                    </template>
                    ...
                    <template #footer>
                        ...
                        <jet-button class="btn-primary float-right" @click="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                            {{ __('Log Out Other Browser Sessions') }}
                        </jet-button>
                    </template>
                </jet-dialog-modal>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                idModal: 'modal-logout-other-browser-sessions',
